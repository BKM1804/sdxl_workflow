...
def main():
    ...
    with torch.inference_mode():
        ...
        cliptextencode_6 = cliptextencode.encode(
            text="a woman doing sexy pose, naked, front view, luxurious bedroom, a window, snowy forest, highres, prominent grain, muted low grain.",
        ...
        loraloadermodelonly_323 = loraloadermodelonly.load_lora_model_only(
            lora_name="marcela_new_1.safetensors",
            strength_model=1.1,
            model=get_value_at_index(checkpointloadersimple_316, 0),
        )

        cliptextencode_317 = cliptextencode.encode(
            text="a embedding:new.pt woman doing sexy pose, naked, front view, luxurious bedroom, a window, snowy forest, highres, prominent grain, muted low grain.\n",
        ...
        loadimage_304 = loadimage.load_image(image="ref.png")
        ...
        previewbridge_262 = previewbridge.doit(
            image="$262-0",
            block=False,
            restore_mask="never",
            images=get_value_at_index(vaedecode_8, 0),
            unique_id=6399891044883000254,
        )
        ...
        bboxdetectfaceparsing_302 = bboxdetectfaceparsing.main(
            ...
            image=get_value_at_index(previewbridge_262, 0),
        )
        ...
        cliptextencodesdxl_357 = cliptextencodesdxl.encode(
            ...
            target_width=768,
            target_height=1024,
            text_g="a embedding:embeddings.pt woman doing sexy pose, naked, front view, luxurious bedroom, a window, snowy forest, highres, prominent grain, muted low grain.\n",
            text_l="a embedding:marcela_new.pt woman doing sexy pose, naked, front view, luxurious bedroom, a window, snowy forest, highres, prominent grain, muted low grain.",
            clip=get_value_at_index(checkpointloadersimple_316, 1),
        )
        ...
        for q in range(1):
            ...
            masktoimage_338 = masktoimage.mask_to_image(
                mask=get_value_at_index(impactgaussianblurmask_350, 0)
            )
